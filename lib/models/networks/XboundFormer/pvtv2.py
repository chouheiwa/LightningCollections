...
class KanPyramidVisionTransformerImpr(PyramidVisionTransformerImpr):
    def __init__(self,
                 img_size=224,
                 patch_size=16,
                 in_chans=3,
                 ...
                 depths=[3, 4, 6, 3],
                 sr_ratios=[8, 4, 2, 1]):
        super().__init__(img_size, patch_size, in_chans, num_classes, embed_dims, num_heads, mlp_ratios, qkv_bias,
                         qk_scale, drop_rate, attn_drop_rate, drop_path_rate, norm_layer, depths, sr_ratios)
